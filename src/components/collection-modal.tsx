          ...
          <div className="grid md:grid-cols-2 gap-0">
            ...
            <div className="relative">
              <img
                src={item.image}
                alt={item.title}
                className="w-full h-[500px] md:h-[700px] object-contain bg-black/5"
              />
            </div>
                ...
                <div className="bg-gradient-hero p-6 rounded-lg text-primary-foreground mt-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <a 
                      ...
                      className="bg-green-600 text-white px-6 py-2 rounded font-semibold hover:bg-green-700 transition-colors text-center flex items-center justify-center gap-2"
                    >
